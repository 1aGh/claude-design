...
Two conventions apply to every command, skill, and agent under `plugins/{flow,design}/`. See [DDR-004](./.ai/decisions/DDR-004-flow-command-naming-prefix-convention.md) (group-prefix filename) and [DDR-191](./.ai/decisions/DDR-191-revert-plugin-name-prefix-claude-code-now-namespaces.md) (bare `name:` — supersedes the now-wrong [DDR-006](./.ai/decisions/DDR-006-plugin-namespace-in-name-frontmatter.md)).
