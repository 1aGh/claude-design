      ...
      <Void theme="dark">
        ...
        <div
          style={{
            ...
            borderRight: swipe > 0.5 ? `1px solid ${t.border}` : 'none',
          }}
        >
          <div
            style={{
              ...
              padding: 52,
              transform: `translateX(${interpolate(swipe, [0, 1], [0, -40])}px)`,
            }}
          >
            ...
            <div style={{ fontFamily: font.body, fontSize: 22, color: t.fg1, marginTop: 16 }}>
        ...
        >
            ...
            {['Next.js', 'Vite', 'Bun', 'raw TSX'].map((fw, i) => (
              <span
                ...
                style={{
                  ...
                  fontSize: 17,
                  color: i === 0 ? t.accent : t.fg1,
                  background: i === 0 ? t.accentTint : t.bg2,
                  border: `1px solid ${i === 0 ? t.accentMuted : t.border}`,
                  borderRadius: 99,
                  padding: '6px 16px',
                }}
              >
          ...
          <div
            style={{
              ...
              fontSize: 18,
              color: t.success,
              opacity: lerp(frame, [132, 146], [0, 1]),
            }}
          >
        ...
        <Phrase
          frame={frame}
          from={100}
          text="hand it off — into any codebase"
          size={30}
          bottom={48}
        />
      </Void>
