...
export const V5Multiplayer = () => {
  ...
  const _title = easeOut(lerp(frame, [130, 152], [0, 1]));
      ...
      <Void theme="dark">
          ...
          >
            ...
            >
              <span
                style={{
                  ...
                  fontSize: 20,
                  color: t.accentFg,
                  background: interpolate(edit, [0, 1], [0.5, 1]) > 0.99 ? t.accent : t.accent,
                  borderRadius: 12,
                  padding: '12px 24px',
                }}
              >
              ...
              <span
                style={{
                  ...
                  padding: '12px 24px',
                  opacity: edit,
                  transform: `scale(${interpolate(edit, [0, 1], [0.7, 1])})`,
              ...
              <span
                style={{
                  ...
                  fontSize: 15,
                  color: t.info,
                  opacity: lerp(frame, [100, 112], [0, 1]) * (1 - lerp(frame, [150, 165], [0, 1])),
                }}
              >
                ↳ Dana added this
              </span>
            ...
            <div
              style={{
                ...
                borderRadius: 18,
                pointerEvents: 'none',
                boxShadow: `inset 0 0 0 3px ${t.success}`,
                opacity: flash,
              }}
            />
          </div>
        ...
        <div
          style={{
            ...
            opacity: peersCard,
            transform: `translateY(${interpolate(peersCard, [0, 1], [-12, 0])}px)`,
            fontFamily: font.mono,
          }}
        >
          <div style={{ fontSize: 14, letterSpacing: '0.1em', color: t.fg2, marginBottom: 14 }}>
            maude hub · 3 connected
          </div>
          {PEERS.map((p) => (
            <div
              key={p.label}
            ...
            >
              ...
              />
              <span style={{ fontSize: 18, color: t.fg0, fontFamily: font.body, fontWeight: 600 }}>
                {p.label}
              </span>
            </div>
          ))}
          ...
          <div style={{ fontSize: 13, color: t.fg3, marginTop: 6 }}>
            peer-to-peer · self-hosted · no SaaS
          </div>
        </div>
