...
const Artboard: React.FC<{
  ...
  title: string;
  selected?: boolean;
}> = ({ x, y, w, h, dim, children, title, selected }) => (
  <div style={{ position: 'absolute', left: x, top: y, width: w, height: h }}>
    <div style={{ fontFamily: font.mono, fontSize: 18, color: t.fg2, marginBottom: 10 }}>
      {title}
    </div>
    <div
      style={{
...
export const V5TalkCanvas = () => {
  ...
  const cx =
    interpolate(cursorLand, [0, 1], [1480, 1000]) * (1 - cursorToComment) + 1180 * cursorToComment;
  const cy =
    interpolate(cursorLand, [0, 1], [290, 446]) * (1 - cursorToComment) + 700 * cursorToComment;
    ...
    <AbsoluteFill>
      <Void theme="dark">
        ...
        >
          ...
          <Artboard x={300} y={820} w={520} h={340} dim title="Settings">
            <div style={{ padding: 28, display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[0, 1, 2, 3].map((i) => (
                <div key={i} style={{ height: 30, background: t.bg2, borderRadius: 8 }} />
              ))}
            </div>
          </Artboard>
          ...
          <Artboard x={920} y={520} w={760} h={480} title="Hero.tsx" selected={selected}>
            <div style={{ padding: 56, position: 'relative', height: '100%', overflow: 'visible' }}>
              ...
              >
                ⌘ <span style={{ color: t.fg0 }}>Hero.tsx</span>:
                <span style={{ color: t.accent }}>42</span>
              </div>
              ...
              <div
                style={{
                  ...
                  top: -44,
                  opacity: doneChip,
                  transform: `translateY(${interpolate(doneChip, [0, 1], [8, 0])}px)`,
                  display: 'flex',
                  alignItems: 'center',
                  gap: 8,
                  fontFamily: font.mono,
              ...
              <div
                style={{
                  ...
                  left: 360,
                  top: 250,
                  opacity: pin * annotFade,
                  transform: `scale(${interpolate(pin, [0, 1], [0.4, 1])})`,
              ...
              >
                ...
                {arrowDraw > 0.92 ? (
                  <path
                    d="M 150 96 l 24 6 m -24 -6 l 8 22"
                    fill="none"
                    stroke={t.accent}
                    strokeWidth={5}
                    strokeLinecap="round"
              ...
              <div
                style={{
                  ...
                  left: 300,
                  top: 210,
                  opacity: note * annotFade,
                  transform: `rotate(-7deg) translateY(${interpolate(note, [0, 1], [8, 0])}px)`,
                  fontFamily: font.display,
                  fontStyle: 'italic',
                  fontWeight: 600,
                  fontSize: 26,
        ...
        <Pointer
          ...
          color={t.presence}
          label="you"
          opacity={lerp(frame, [104, 116], [0, 1]) * cursorFade}
        />
        ...
        <Phrase
          frame={frame}
          from={248}
          text="you point. you draw. it understands."
          align="center"
          size={38}
          accent
          bottom={120}
