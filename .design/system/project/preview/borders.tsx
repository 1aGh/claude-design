 ...
 * @opt_out     none
 * @artboards   primary
 * @brief       MDCC-DSN/01.borders / md-claude
...
export default function Borders() {
  return (
    <>
          <header className="specimen-hd"><span className="sku">MDCC-DSN/01.borders</span><span className="crumbs"><span>md-claude</span><span>design system</span><span>foundation</span><span>borders</span></span><span className="theme-toggle" role="tablist" aria-label="Theme"><button data-theme="light">LIGHT</button><button data-theme="dark">DARK</button></span></header>
          <main className="specimen">
            ...
            <footer className="specimen-ft"><div className="colo-block"><strong>MDCC-DSN/01</strong><span>· borders</span></div><div className="colo-block"><span>md-claude · v0.12.0</span></div></footer>
          </main>
        </>
  );
}
