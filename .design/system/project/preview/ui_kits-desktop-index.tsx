 ...
 * @opt_out     none
 * @artboards   primary
 * @brief       MDCC-DSN/01 / md-claude · catalog index
...
export default function UiKitsDesktopIndex() {
  return (
    <>
          <header className="specimen-hd"><span className="sku">MDCC-DSN/01 · INDEX</span><span className="crumbs"><span>md-claude</span><span>design system</span><span>desktop</span><span>index</span></span><span className="theme-toggle" role="tablist" aria-label="Theme"><button data-theme="light">LIGHT</button><button data-theme="dark">DARK</button></span></header>
          <main className="specimen">
            ...
            <footer className="specimen-ft"><div className="colo-block"><strong>MDCC-DSN/01</strong><span>· ui_kits-desktop-index · 36 specimens</span></div><div className="colo-block"><span>md-claude · v0.12.0</span></div></footer>
          </main>
        </>
  );
}
