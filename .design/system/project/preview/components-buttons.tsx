 ...
 * @opt_out     none
 * @artboards   primary
 * @brief       MDCC-DSN/01.components-buttons / md-claude
  ...
  return (
    <>
          <header className="specimen-hd">
            ...
            <span className="crumbs"><span>md-claude</span><span>design system</span><span>components</span><span>buttons</span></span>
