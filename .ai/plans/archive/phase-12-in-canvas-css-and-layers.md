...
- [x] Gate decision recorded (Task 0 DDR-103): survey waived; CSS=inline-style merge + text=escaped JSXText overwrite; Phase-10 dropped; reorder → phase-12.1.
