...
**Phase:** phase-8-live-collaboration-yjs-lan (Tasks 0–3 ship-ready; Tasks 4–8 follow up)
**Status:** ship-ready — Tasks 2 + 3 complete + verified; awaiting commit/PR
**Started:** 2026-05-26
**Updated:** 2026-05-26
**Active task:** — (Tasks 4–8 in follow-up: AI banner / annotations / participant chrome / git-lifecycle / stress harness)
