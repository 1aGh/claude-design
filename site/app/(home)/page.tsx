    ...
    <main className="mdcc-landing" id="plugins">
      <section className="mdcc-hero" aria-labelledby="land-h1">
        <div className="mdcc-hero-copy">
          ...
          <p>
            Two plugins, one CLI, zero feelings about your CSS framework. <code>design</code>{' '}
            iterates on HTML mocks. <code>flow</code> runs the agentic loop until the feature
            actually ships. <code>mdcc</code> scaffolds the second-brain <code>.ai/</code> workspace
            they both pretend they could live without.
          </p>
