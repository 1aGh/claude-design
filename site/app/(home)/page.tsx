		...
		<main className="mdcc-landing" id="main-content">
			<section className="mdcc-hero" aria-labelledby="land-h1">
				<div className="mdcc-hero-copy">
					...
					<p>
						<code>design</code> iterates on HTML mocks. <code>flow</code> runs the agentic loop until the feature
						actually ships. <code>maude</code> scaffolds the second-brain <code>.ai/</code> workspace they both
						pretend they could live without.
					</p>
			...
			<footer>
				<div className="mdcc-maker-signature">
					...
					<p>
						Hi I&apos;m Michal, I made this. Open issues if it breaks. <Link href="/about">More.</Link>
					</p>
				</div>
