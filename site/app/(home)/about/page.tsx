...
export const metadata: Metadata = {
	...
	description: "Hi I'm Michal and I build things. Maude is a small set of vibe-design and vibe-code workflows for Claude Code.",
};
		...
		<main className="mdcc-landing" id="main-content">
			<section className="mdcc-about" aria-labelledby="about-h1">
				<div className="mdcc-about-copy">
					...
					<p>
						Maude is a small set of vibe-design and vibe-code workflows for Claude Code. Two plugins, one CLI,
						some opinions about HTML mocks. I built it, mostly at night, because I kept needing it.
					</p>

					<p>I don&apos;t fully understand why it works, but it works.</p>

					<p>I like nerdy jokes and tools without analytics. Based in Brno Czechia</p>

					<p>If it breaks it&apos;s almost certainly my fault. Open an issue. I read them (some times).</p>
				</div>
