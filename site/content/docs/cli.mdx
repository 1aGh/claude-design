...
<FileTree variant="cli-subcommands" caption="The maude CLI surface — six subcommands plus version / help" />
...
<CommandFlow variant="init" caption="From install to your first plan" />
