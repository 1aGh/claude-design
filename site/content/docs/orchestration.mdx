...
It is **opt-out**: on by default, capability-gated, and additive. With nothing configured you get the cheap panel; with the experimental agent-teams flag on you get the live debate; one config line turns it off. Canonical decision: [DDR-130](https://github.com/1aGh/maude/blob/main/.ai/archive/decisions/DDR-130-bookend-debate-layer.md).
