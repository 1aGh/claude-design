...
The full JSON Schema lives at [`plugins/flow/.claude-plugin/config.schema.json`](https://github.com/1aGh/maude/blob/main/plugins/flow/.claude-plugin/config.schema.json). Reference it via `$schema` for editor autocomplete + diagnostics.
