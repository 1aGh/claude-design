...
[**`plugins/flow/commands/release-changelog.md`**](https://github.com/1aGh/maude/blob/main/plugins/flow/commands/release-changelog.md) → read it for the full behavior.
