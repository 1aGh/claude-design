...
[**`plugins/flow/commands/validate-security.md`**](https://github.com/1aGh/maude/blob/main/plugins/flow/commands/validate-security.md) → read it for the full behavior.
