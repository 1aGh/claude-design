...
The `<group>-<verb>` prefix landed in **v0.6.0** (Phase 13). Eleven commands were renamed; the backwards-compat stubs lived for ~24h and were removed in **v0.6.1**. See [DDR-004](https://github.com/1aGh/maude/blob/main/.ai/archive/decisions/DDR-004-flow-command-naming-prefix-convention.md) for the rationale.

<CommandTree plugin="flow" caption="All 30 flow commands by group — each leaf links to its reference page" />
