...
The canonical catalog: [`plugins/flow/CATEGORIES.md`](https://github.com/1aGh/maude/blob/main/plugins/flow/CATEGORIES.md). Live grouped index, one slash command away: `/flow:help`.
...
The `<group>-<verb>` prefix landed in **v0.6.0** (Phase 13). Eleven commands were renamed; the backwards-compat stubs lived for ~24h and were removed in **v0.6.1**. See [DDR-004](https://github.com/1aGh/maude/blob/main/.ai/decisions/DDR-004-flow-command-naming-prefix-convention.md) for the rationale.
