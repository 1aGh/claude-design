...
Maude Cloud is in private pilot. This notice describes the service as it is built today; the provider's registration number is added, and the pack reviewed by counsel, before the first live charge.
</Callout>
...
**Michal Dovrtěl**, Brno, Czech Republic — the controller for the personal data described here, and the processor for the design work you store (that relationship is governed by the [DPA](/docs/legal/dpa)). Contact: **cloud@maude.sh**.
