...
The subprocessor list is in the [DPA](/docs/legal/dpa) and is part of it: **Cloudflare** (hosting, storage, DNS), **Stripe** (payments), **Resend** (transactional email), **Vercel** (this documentation site only — no customer project data).
