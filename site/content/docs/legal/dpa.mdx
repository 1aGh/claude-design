...
Maude Cloud is in private pilot. This addendum is published so it can be read and negotiated before the service takes live money; it is reviewed by counsel before the first live charge.
</Callout>
...
| Who | What for | Where |
| --- | --- | --- |
| **Cloudflare** | Workspace hosting (Containers, Durable Objects), object storage (R2), DNS and TLS, and first-party usage events (Analytics Engine) | EU |
