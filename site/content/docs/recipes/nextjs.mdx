...
Drop-in setup for a Next.js app. Five steps, four optional. App Router, Tailwind, Vitest assumed. Adjust where your stack diverges.

**Starting point:** existing Next.js 15+ app, pnpm or npm, Tailwind, App Router.

## 1. Install the marketplace and CLI
