...
Comments and annotations are additive CRDT operations — they merge without loss. Only canvas-body conflicts (rare) resolve last-write-wins, with a notification to the disadvantaged peer.
