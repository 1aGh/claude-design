...
The hub wraps [Hocuspocus](https://tiptap.dev/docs/hocuspocus) (production-tested, MIT, Node-native). Why not PartyKit / Liveblocks: [DDR-052](https://github.com/1aGh/maude/blob/main/.ai/archive/decisions/DDR-052-hocuspocus-over-partykit-for-hub.md).
