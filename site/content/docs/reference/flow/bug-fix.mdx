...
| **Source** | [`plugins/flow/commands/bug-fix.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/bug-fix.md) |
...
[**`plugins/flow/commands/bug-fix.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/bug-fix.md) → read it for the full behavior.
