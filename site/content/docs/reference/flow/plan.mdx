...
| **Source** | [`plugins/flow/commands/plan.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/plan.md) |
...
[**`plugins/flow/commands/plan.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/plan.md) → read it for the full behavior.
