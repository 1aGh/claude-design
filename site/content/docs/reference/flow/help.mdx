...
| **Source** | [`plugins/flow/commands/help.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/help.md) |
...
[**`plugins/flow/commands/help.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/help.md) → read it for the full behavior.
