...
| **Source** | [`plugins/flow/commands/done.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/done.md) |
...
[**`plugins/flow/commands/done.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/done.md) → read it for the full behavior.
