...
| **Source** | [`plugins/flow/commands/setup-prd.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-prd.md) |
...
[**`plugins/flow/commands/setup-prd.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-prd.md) → read it for the full behavior.
