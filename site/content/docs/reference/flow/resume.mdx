...
| **Source** | [`plugins/flow/commands/resume.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/resume.md) |
...
[**`plugins/flow/commands/resume.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/resume.md) → read it for the full behavior.
