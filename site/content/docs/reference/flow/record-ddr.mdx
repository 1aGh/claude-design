...
| **Source** | [`plugins/flow/commands/record-ddr.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/record-ddr.md) |
...
[**`plugins/flow/commands/record-ddr.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/record-ddr.md) → read it for the full behavior.
