...
| **Source** | [`plugins/flow/commands/record-retro.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/record-retro.md) |
...
[**`plugins/flow/commands/record-retro.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/record-retro.md) → read it for the full behavior.
