...
| **Source** | [`plugins/flow/commands/review-code.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/review-code.md) |
...
[**`plugins/flow/commands/review-code.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/review-code.md) → read it for the full behavior.
