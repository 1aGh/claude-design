...
| **Source** | [`plugins/flow/commands/quick.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/quick.md) |
...
[**`plugins/flow/commands/quick.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/quick.md) → read it for the full behavior.
