...
| **Source** | [`plugins/flow/commands/setup-context.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-context.md) |
...
[**`plugins/flow/commands/setup-context.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-context.md) → read it for the full behavior.
