...
| **Source** | [`plugins/flow/commands/validate-a11y.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/validate-a11y.md) |
...
[**`plugins/flow/commands/validate-a11y.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/validate-a11y.md) → read it for the full behavior.
