...
| **Source** | [`plugins/flow/commands/setup-codebase-map.md`](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-codebase-map.md) |
...
[**`plugins/flow/commands/setup-codebase-map.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/flow/commands/setup-codebase-map.md) → read it for the full behavior.
