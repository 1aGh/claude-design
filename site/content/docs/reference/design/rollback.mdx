...
| **Source** | [`plugins/design/commands/rollback.md`](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/rollback.md) |
...
[**`plugins/design/commands/rollback.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/rollback.md) → read it for the full behavior.
