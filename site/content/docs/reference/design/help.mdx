...
| **Source** | [`plugins/design/commands/help.md`](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/help.md) |
...
[**`plugins/design/commands/help.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/help.md) → read it for the full behavior.
