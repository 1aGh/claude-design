...
| **Source** | [`plugins/design/commands/smoke.md`](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/smoke.md) |
...
[**`plugins/design/commands/smoke.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/smoke.md) → read it for the full behavior.
