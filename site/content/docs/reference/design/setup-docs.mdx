...
| **Category** | `setup` |
| **Argument hint** | `[--full]` |
| **Source** | [`plugins/design/commands/setup-docs.md`](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/setup-docs.md) |
...
[**`plugins/design/commands/setup-docs.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/setup-docs.md) → read it for the full behavior.
