...
| **Source** | [`plugins/design/commands/new.md`](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/new.md) |
...
```text
/design:new <Name> \"<brief>\" [--component] [--mobile] [--quick | --no-critic] [--perfect-iter N] [--opt-out=palette|aesthetic|full]
```
...
[**`plugins/design/commands/new.md`**](https://github.com/1aGh/md-claude/blob/main/plugins/design/commands/new.md) → read it for the full behavior.
