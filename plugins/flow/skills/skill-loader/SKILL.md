...
- `/flow:onboard` or `/flow:context` is bootstrapping a new repo.
...
- `/flow:onboard` or `/flow:context` is running and is about to write the codebase map.
