  ...
  transact(doc2, (transaction) => {
    while (stack.length > 0 && undoManager.currStackItem === null) {
      ...
      iterateDeletedStructs(transaction, stackItem.deletions, (struct) => {
        if (struct instanceof Item && scope.some((type) => type === transaction.doc || isParentOf(type, struct)) && !isDeleted(stackItem.insertions, struct.id)) {
...
class UndoManager extends ObservableV2 {
  constructor(typeScope, {
    ...
    doc: doc2 = isArray(typeScope) ? typeScope[0].doc : typeScope instanceof Doc ? typeScope : typeScope.doc
  } = {}) {
    super();
    this.scope = [];
    this.doc = doc2;
...
var typeMapGetSnapshot = (parent, key, snapshot2) => {
  ...
  return v !== null && isVisible(v, snapshot2) ? v.content.getContent()[v.length - 1] : undefined;
};
...
var isDeletedByUndoStack = (stack, id2) => some(stack, (s) => isDeleted(s.deletions, id2));
...
var {
  ...
  Array: Array2,
  ContentAny: ContentAny2,
  ContentBinary: ContentBinary2,
  ContentDeleted: ContentDeleted2,
  ContentDoc: ContentDoc2,
  ContentEmbed: ContentEmbed2,
  ContentFormat: ContentFormat2,
  ContentJSON: ContentJSON2,
  ...
  Item: Item2,
  Map: Map2,
  PermanentUserData: PermanentUserData2,
  ...
  UpdateDecoderV1: UpdateDecoderV12,
  UpdateDecoderV2: UpdateDecoderV22,
  UpdateEncoderV1: UpdateEncoderV12,
  UpdateEncoderV2: UpdateEncoderV22,
  XmlElement,
  XmlFragment,
  XmlHook,
  XmlText,
  YArrayEvent: YArrayEvent2,
  YEvent: YEvent2,
  YMapEvent: YMapEvent2,
  YTextEvent: YTextEvent2,
  YXmlEvent: YXmlEvent2,
  applyUpdate: applyUpdate2,
  applyUpdateV2: applyUpdateV22,
  cleanupYTextFormatting: cleanupYTextFormatting2,
  compareIDs: compareIDs2,
  compareRelativePositions: compareRelativePositions2,
  convertUpdateFormatV1ToV2: convertUpdateFormatV1ToV22,
  convertUpdateFormatV2ToV1: convertUpdateFormatV2ToV12,
  createAbsolutePositionFromRelativePosition: createAbsolutePositionFromRelativePosition2,
  createDeleteSet: createDeleteSet2,
  createDeleteSetFromStructStore: createDeleteSetFromStructStore2,
  createDocFromSnapshot: createDocFromSnapshot2,
  createID: createID2,
  createRelativePositionFromJSON: createRelativePositionFromJSON2,
  createRelativePositionFromTypeIndex: createRelativePositionFromTypeIndex2,
  createSnapshot: createSnapshot2,
  decodeRelativePosition: decodeRelativePosition2,
  decodeSnapshot: decodeSnapshot2,
  decodeSnapshotV2: decodeSnapshotV22,
  decodeStateVector: decodeStateVector2,
  decodeUpdate: decodeUpdate2,
  decodeUpdateV2: decodeUpdateV22,
  diffUpdate: diffUpdate2,
  diffUpdateV2: diffUpdateV22,
  emptySnapshot: emptySnapshot2,
  encodeRelativePosition: encodeRelativePosition2,
  encodeSnapshot: encodeSnapshot2,
  encodeSnapshotV2: encodeSnapshotV22,
  encodeStateAsUpdate: encodeStateAsUpdate2,
  encodeStateAsUpdateV2: encodeStateAsUpdateV22,
  encodeStateVector: encodeStateVector2,
  encodeStateVectorFromUpdate: encodeStateVectorFromUpdate2,
  encodeStateVectorFromUpdateV2: encodeStateVectorFromUpdateV22,
  equalDeleteSets: equalDeleteSets2,
  equalSnapshots: equalSnapshots2,
  findIndexSS: findIndexSS2,
  findRootTypeKey: findRootTypeKey2,
  getItem: getItem2,
  getItemCleanEnd: getItemCleanEnd2,
  getItemCleanStart: getItemCleanStart2,
  getState: getState2,
  getTypeChildren: getTypeChildren2,
  isDeleted: isDeleted2,
  isParentOf: isParentOf2,
  iterateDeletedStructs: iterateDeletedStructs2,
  logType: logType2,
  logUpdate: logUpdate2,
  logUpdateV2: logUpdateV22,
  mergeDeleteSets: mergeDeleteSets2,
  mergeUpdates: mergeUpdates2,
  mergeUpdatesV2: mergeUpdatesV22,
  obfuscateUpdate: obfuscateUpdate2,
  obfuscateUpdateV2: obfuscateUpdateV22,
  parseUpdateMeta: parseUpdateMeta2,
  parseUpdateMetaV2: parseUpdateMetaV22,
  readUpdate: readUpdate2,
  readUpdateV2: readUpdateV22,
  relativePositionToJSON: relativePositionToJSON2,
  snapshot: snapshot2,
  snapshotContainsUpdate: snapshotContainsUpdate2,
  transact: transact2,
  tryGc: tryGc2,
  typeListToArraySnapshot: typeListToArraySnapshot2,
  typeMapGetAllSnapshot: typeMapGetAllSnapshot2,
  typeMapGetSnapshot: typeMapGetSnapshot2
} = exports_yjs;
var __runtime_bundle_yjs_entry_default = exports_yjs;
export {
  typeMapGetSnapshot2 as typeMapGetSnapshot,
  typeMapGetAllSnapshot2 as typeMapGetAllSnapshot,
  typeListToArraySnapshot2 as typeListToArraySnapshot,
  tryGc2 as tryGc,
  transact2 as transact,
  snapshotContainsUpdate2 as snapshotContainsUpdate,
  snapshot2 as snapshot,
  relativePositionToJSON2 as relativePositionToJSON,
  readUpdateV22 as readUpdateV2,
  readUpdate2 as readUpdate,
  parseUpdateMetaV22 as parseUpdateMetaV2,
  parseUpdateMeta2 as parseUpdateMeta,
  obfuscateUpdateV22 as obfuscateUpdateV2,
  obfuscateUpdate2 as obfuscateUpdate,
  mergeUpdatesV22 as mergeUpdatesV2,
  mergeUpdates2 as mergeUpdates,
  mergeDeleteSets2 as mergeDeleteSets,
  logUpdateV22 as logUpdateV2,
  logUpdate2 as logUpdate,
  logType2 as logType,
  iterateDeletedStructs2 as iterateDeletedStructs,
  isParentOf2 as isParentOf,
  isDeleted2 as isDeleted,
  getTypeChildren2 as getTypeChildren,
  getState2 as getState,
  getItemCleanStart2 as getItemCleanStart,
  getItemCleanEnd2 as getItemCleanEnd,
  getItem2 as getItem,
  findRootTypeKey2 as findRootTypeKey,
  findIndexSS2 as findIndexSS,
  equalSnapshots2 as equalSnapshots,
  equalDeleteSets2 as equalDeleteSets,
  encodeStateVectorFromUpdateV22 as encodeStateVectorFromUpdateV2,
  encodeStateVectorFromUpdate2 as encodeStateVectorFromUpdate,
  encodeStateVector2 as encodeStateVector,
  encodeStateAsUpdateV22 as encodeStateAsUpdateV2,
  encodeStateAsUpdate2 as encodeStateAsUpdate,
  encodeSnapshotV22 as encodeSnapshotV2,
  encodeSnapshot2 as encodeSnapshot,
  encodeRelativePosition2 as encodeRelativePosition,
  emptySnapshot2 as emptySnapshot,
  diffUpdateV22 as diffUpdateV2,
  diffUpdate2 as diffUpdate,
  __runtime_bundle_yjs_entry_default as default,
  decodeUpdateV22 as decodeUpdateV2,
  decodeUpdate2 as decodeUpdate,
  decodeStateVector2 as decodeStateVector,
  decodeSnapshotV22 as decodeSnapshotV2,
  decodeSnapshot2 as decodeSnapshot,
  decodeRelativePosition2 as decodeRelativePosition,
  createSnapshot2 as createSnapshot,
  createRelativePositionFromTypeIndex2 as createRelativePositionFromTypeIndex,
  createRelativePositionFromJSON2 as createRelativePositionFromJSON,
  createID2 as createID,
  createDocFromSnapshot2 as createDocFromSnapshot,
  createDeleteSetFromStructStore2 as createDeleteSetFromStructStore,
  createDeleteSet2 as createDeleteSet,
  createAbsolutePositionFromRelativePosition2 as createAbsolutePositionFromRelativePosition,
  convertUpdateFormatV2ToV12 as convertUpdateFormatV2ToV1,
  convertUpdateFormatV1ToV22 as convertUpdateFormatV1ToV2,
  compareRelativePositions2 as compareRelativePositions,
  compareIDs2 as compareIDs,
  cleanupYTextFormatting2 as cleanupYTextFormatting,
  applyUpdateV22 as applyUpdateV2,
  applyUpdate2 as applyUpdate,
  YXmlEvent2 as YXmlEvent,
  YTextEvent2 as YTextEvent,
  YMapEvent2 as YMapEvent,
  YEvent2 as YEvent,
  YArrayEvent2 as YArrayEvent,
  XmlText,
  XmlHook,
  XmlFragment,
  XmlElement,
  UpdateEncoderV22 as UpdateEncoderV2,
  UpdateEncoderV12 as UpdateEncoderV1,
  UpdateDecoderV22 as UpdateDecoderV2,
  UpdateDecoderV12 as UpdateDecoderV1,
  UndoManager2 as UndoManager,
  Transaction2 as Transaction,
  Text,
  Snapshot2 as Snapshot,
  Skip2 as Skip,
  RelativePosition2 as RelativePosition,
  PermanentUserData2 as PermanentUserData,
  Map2 as Map,
  Item2 as Item,
  ID2 as ID,
  GC2 as GC,
  ...
  ContentString2 as ContentString,
  ContentJSON2 as ContentJSON,
  ContentFormat2 as ContentFormat,
  ContentEmbed2 as ContentEmbed,
  ContentDoc2 as ContentDoc,
  ContentDeleted2 as ContentDeleted,
  ContentBinary2 as ContentBinary,
  ContentAny2 as ContentAny,
  Array2 as Array,
  AbstractType2 as AbstractType,
  AbstractStruct2 as AbstractStruct,
  AbstractConnector2 as AbstractConnector,
  AbsolutePosition2 as AbsolutePosition
};
