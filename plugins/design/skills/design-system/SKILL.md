...
- **BOOTSTRAP** → load [`_bootstrap.md`](./_bootstrap.md) only (it carries discovery, scaffold, the 4-kola post-scaffold gate, and Post-Flight). Discovery probes load on demand from [`_pastier-probe-templates.md`](./_pastier-probe-templates.md) when you reach Stage 2.
